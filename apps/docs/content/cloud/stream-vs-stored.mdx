...
[Sessions & resume](/docs/concepts/resume) for resuming a still-in-progress job
instead.
...
[Zero-egress exports](/docs/guides/zero-egress-exports) and
...
one — call [`SessionsClient`](/docs/concepts/resume) directly and omit `mode`
