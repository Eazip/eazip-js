...
to hand the job to [Eazip Cloud](https://eazip.io/cloud/?utm_source=eazip_js_docs&utm_medium=docs&utm_campaign=cloud_activation&utm_content=getting_started_scale):
...
Get a public key at [eazip.io](https://eazip.io/cloud/?utm_source=eazip_js_docs&utm_medium=docs&utm_campaign=cloud_activation&utm_content=getting_started_public_key).
